...
export async function proxy(req: NextRequest) {
  ...
  const csp = [
    "default-src 'self'",
    "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://*.mercadopago.com https://*.stripe.com https://js.sentry-cdn.com https://va.vercel-scripts.com https://maps.googleapis.com https://maps.gstatic.com https://static.cloudflareinsights.com",
