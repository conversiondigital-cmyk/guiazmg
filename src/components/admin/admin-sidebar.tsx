...
const sections: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Branding", href: "/admin/configuracion/branding", icon: Images },
      { label: "Contacto y redes", href: "/admin/configuracion/contacto", icon: Globe },
      ...
      { label: "Google Maps", href: "/admin/configuracion/mapas", icon: MapPinned },
      ...
      { label: "Eventos (RSS)", href: "/admin/configuracion/eventos", icon: CalendarDays },
      { label: "SEO global", href: "/admin/configuracion/seo", icon: Search },
      { label: "Landing (destacados)", href: "/admin/configuracion/landing", icon: Images },
      { label: "Marketplace", href: "/admin/configuracion/marketplace", icon: Package },
      { label: "Onboarding", href: "/admin/configuracion/onboarding", icon: Settings },
...
export function AdminSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-72 flex-col border-r border-slate-200 bg-white text-slate-700 shadow-sm transition-transform lg:sticky lg:top-0 lg:h-screen lg:translate-x-0",
