...
export default async function NuevoServicioPage() {
  ...
  // Sin negocio no hay dónde colgar el servicio: manda a registrar/completar.
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-gray-900">Agregar servicio</h1>
        <p className="text-gray-500">Aparecerá en el catálogo de tu perfil público.</p>
      </div>

      {!business.categoryId ? (
        <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
          Tu negocio necesita una categoría antes de agregar servicios.{" "}
